...
Url:            https://gitlab.suse.de/vtheile/prometheus-webhook-snmp
Source0:        https://gitlab.suse.de/vtheile/prometheus-webhook-snmp/-/archive/master/%{name}-master.tar.bz2
BuildArch:      noarch
